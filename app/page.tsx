...
function FeatureCard({ 
  ...
  return (
    <div className={`border-4 border-neo-black shadow-neo-sm p-6 flex gap-6 items-start ${color} ${rotation} hover:rotate-0 hover:-translate-y-1 hover:shadow-neo-md transition-all duration-200`}>
      <div className="bg-neo-bg text-neo-black border-4 border-neo-black p-3 shrink-0">
        {icon}
      </div>
      <div>
        ...
        <p className="font-bold text-lg leading-snug opacity-90">
          {desc}
        </p>
      </div>
    </div>
